...
while (numTopics > 1)
      ...
      %end;
      [selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPair(numTopics, randomWalkMatrix, topicIndexes, clusterAssignments, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix);
