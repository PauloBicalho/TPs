function mergeTopics(inputFile, outputDir)
...
minProbability1 = minProbability;
...
while (numTopics > 1)
      ...
      %[selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPair(numTopics, randomWalkMatrix, topicIndexes, clusterAssignments, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix, iter_n, outputDir, stationaryProbabilities);
      
      [selectedRows, selectedColumns, maxProbabilities] = selectBestTopicPair(numTopics, randomWalkMatrix, topicIndexes, clusterAssignments, mapTopics, originalNumTopics, alpha, minProbability, maxCohesion, transitionMatrix, iter_n, outputDir, stationaryProbabilities, irreducibleMatrix, leavingProbability, meanNumberOfLinks);

      fprintf(outputFileTopics,'%%%%%% Iteration - %d\n', iter_n);
      printf("Max: %f\n", maxProbabilities(currentIndex))
      while ( (currentIndex < numTopics) && ( (maxProbabilities(currentIndex) ) > 0.0) )
